...
function Artist() {
  ...
  useEffect(() => {
    async function fetchArtist() {
      try {
        let response = await fetch("https://striveschool-api.herokuapp.com/api/deezer/artist/" + params.id, {
          method: "GET",
          headers,
        });
          ...
          <Row>
            ...
            <Col xs={12}>
                ...
                <Row>
                  <Col class="col-12 col-md-10 col-lg-10 mt-5">
                    ...
                    <div class="d-flex justify-content-center mb-5" id="button-container">
                      <Button id="follow-button" className="btn btn-success mainButton d-inline" type="button">
                        Play
                      </Button>
                      <Button id="follow-button" className="btn btn-dark mainButton d-inline" type="button">
                        Follow
                      </Button>
                    </div>
                  </Col>
              ...
              <Row className="mx-5">
                ...
                {tracks && tracks.map((track) => <TrackCard key={track.id} track={track} />)}
              </Row>
            </Col>
            <Col xs={12}>
              <Playbar />
